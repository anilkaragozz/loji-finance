...
import { useUpdateDebtById } from "@/services/hooks/mutations";
...
const DebtUpdateForm = (params: { data: DebtData }) => {
  ...
  useEffect(() => {
    if (params.data) {
      ...
      debtUpdateForm.reset(params.data);
    }
  }, [params.data]);

  const { mutate, isPending } = useUpdateDebtById(params.data.id);
